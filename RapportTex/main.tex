...
% in the abstract
\begin{abstract}
In this project we create a dungeon generator which uses player input as base for the generation. As the player moves throughout a dungeon, the actions taken determines how the rest of the dungeon is generated.
\end{abstract}
...
\bibitem{Astar}
Patrick Lester, \emph{A* Pathfinding for Beginners}, http://homepages.abdn.ac.uk/f.guerin/pages/teaching/CS1013/practicals/aStarTutorial.htm, Last visit: 13-12-2015
